...
describe("Test Data Builder", () => {
  ...
  describe("Product Validation Rules", () => {
    ...
    it("should return an object error when creating a Product with invalid name", () => {
      ...
      const expected = {
        errors: [
          "name: invalid value, current [name123] expected to have only words",
        ],
        result: false,
      };
    ...
    it("should return an object error when creating a Product with invalid price", () => {
      ...
      const expected = {
        errors: [
          "price: invalid value, current [5000] expected to be between 1 and 1000",
        ],
        result: false,
      };
    ...
    it("should return an object error when creating a Product with invalid category", () => {
      ...
      const expected = {
        errors: [
          "category: invalid value, current [none] expected to be either electronic or organic",
        ],
        result: false,
      };
