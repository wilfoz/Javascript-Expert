...
process.on("unhandledRejection", (e) => {
  console.log("UnhandledPromiseRejection", e.message || e);
});
...
// se o Promise.reject estiver dentro de um outro contexto uncaughtException
...
// mas se ele estiver no contexto global, ele cai no
setTimeout(() => {
