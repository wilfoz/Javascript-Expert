...
describe("CarService Suite Tests", () => {
  ...
  it("should choose the first id from carIds in carCategory", () => {
    ...
    const expected = carCategory.carId[carIdIndex];
  ...
  it("given a carCategory it should return an available car", async () => {
    ...
    const cartCategory = Object.create(mocks.validCarCategory);
    cartCategory.carId = [car.id];
    ...
    const result = await carService.getAvailableCar(cartCategory);
    const expected = car;
